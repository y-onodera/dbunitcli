...
public class RunTest {
    ...
    abstract static class TestCase {
        ...
        public void testAntRun() throws Exception {
            RunTest.cmd = "ant";
            Run.main(new String[]{"@" + RunTest.PARAMETER_DIR + "/paramRunAntNoProperty.txt"});
        ...
        public void testAntRunWithProperty() throws Exception {
            RunTest.cmd = "ant";
            Run.main(new String[]{"@" + RunTest.PARAMETER_DIR + "/paramRunAntWithProperty.txt"});
        ...
        protected String getResult() {
            return this.getBaseDir().replace("/command", "") + "/" + RunTest.cmd;
        }
