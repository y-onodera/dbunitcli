...
public class ParameterizeTest {
    ...
    abstract static class TestCase {
        ...
        public void testDataDrivenExport() {
            Parameterize.main(new String[]{"@" + PARAMETER_DIR + "/paramDataDrivenExport.txt"});
        }

        @Test
        public void testDataDrivenExecute() {
            Parameterize.main(new String[]{"@" + PARAMETER_DIR + "/paramDataDrivenExecute.txt"});
        }
        ...
        public void testSpaceContainsPathAsSrcParameter() {
            Parameterize.main(new String[]{"-param.src=" + baseDir + "src/csv/has space"
                    , "-param.srcType=file"
                    , "-cmd=convert"
                    , "-template=" + baseDir + "/settings/param/convertTemplate.txt"});
        }
        ...
        public void testExecCommandNoneParameter() {
            Parameterize.main(new String[]{
                    ...
                    , "-arg=-result=target/test-classes/yo/dbunitcli/application/command/param/csv2xlsx/result"
                    , "-P=cmdName=convert"
                    , "-PtemplateName=" + PARAMETER_DIR + "/paramConvertCsvToXlsx.txt"
            });
            Parameterize.main(new String[]{
                    "-cmd=compare"
