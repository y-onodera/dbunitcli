...
public class GenerateTest {
    ...
    public static void setUp() throws UnsupportedEncodingException {
        GenerateTest.baseDir = URLDecoder.decode(Objects.requireNonNull(GenerateTest.class.getResource(".")).getPath(),
    ...
    abstract static class TestCase {
        ...
        public void testGenerateXlsx(boolean formulaProcess) throws Exception {
            ...
            if (formulaProcess) {
                Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateXlsx.txt"
                ...
                Generate.main(new String[]{
                        "@" + GenerateTest.PARAMETER_DIR + "/paramGenerateXlsx.txt"
        ...
        public void testGenerateXls() throws IOException {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateXls.txt"});
            Compare.main(new String[]{
                    "@" + GenerateTest.testResourcesDir + "/expect/generate/table/expect/xls/compareResult.txt"
                    , "-old.src=" + GenerateTest.testResourcesDir + "/expect/generate/table/expect/Test1"
        ...
        public void testGenerateTxt() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateTxt.txt"});
        ...
        public void testGenerateTxtPerTable() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateTxtPerTable.txt"});
        ...
        public void testGenerateTxtWithMetaData() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateTxtWithMetaData.txt"});
        ...
        public void testGenerateSettings() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateSettings.txt"});
        ...
        public void testGenerateSettingsWithIncludeAllColumns() throws Exception {
            Generate.main(
                    new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateSettingsWithIncludeAllColumns.txt"});
            GenerateTest.subDirectory = "generate/settings";
        ...
        @Test
        public void testGenerateJavaBeanWithMapping() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateJavaBeanWithMapping.txt"});
            GenerateTest.subDirectory = "generate/javabean";
            this.assertGenerateFileEquals("Employee.java", "UTF-8");
        }
        ...
        public void testGenerateInsertNoCommit() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateInsertNoCommit.txt"});
        ...
        public void testGenerateDelete() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateDelete.txt"});
        ...
        public void testGenerateDeleteNoCommit() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateDeleteNoCommit.txt"});
            GenerateTest.subDirectory = "generate/sql/no-commit";
        ...
        public void testGenerateCleanInsert() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateCleanInsert.txt"});
        ...
        public void testGenerateRefresh() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateRefresh.txt"});
        ...
        public void testGenerateUpdate() throws Exception {
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateUpdate.txt"});
        ...
        public void testGenerateUserFormulas(boolean formulaProcess) {
            ...
            Compare.main(new String[]{
                    ...
                    ,
                    "-result=target/test-classes/yo/dbunitcli/application/command/generate/result" +
                            "/compare_user_formula" + resultSuffix
            });
        }
        ...
        public void testGenerateFromJoinTable(boolean formulaProcess) {
            ...
            Compare.main(new String[]{
                    ...
                    , "-settingEncoding=UTF-8"
                    , "-result=target/test-classes/yo/dbunitcli/application/command/generate/with_metadata/result" +
        ...
        public void testGenerateXlsxTemplate(boolean formulaProcess) {
            ...
            Generate.main(new String[]{"@" + GenerateTest.PARAMETER_DIR + "/paramGenerateXlsxTemplate.txt"});
            if (formulaProcess) {
                Generate.main(new String[]{
                        "-srcType=csv"
            ...
            Compare.main(new String[]{
                    ...
                    , "-setting=src/test/resources/yo/dbunitcli/application/settings/generate/with_metadata/settings.json"
                    ,
                    "-result=target/test-classes/yo/dbunitcli/application/command/generate/xlsxTemplate/result" +
                            "/compare" + compareResultSuffix
            });
        }
