...
class WorkspaceControllerTest {
    ...
    public void testList() {
        ...
        Assertions.assertEquals(String.format("{\"parameterList\":{\"convert\":[\"csvToXlsx\"],\"compare\":[\"csvCsv\"],\"generate\":[\"csvToTxt\"],\"run\":[\"runSql\"],\"parameterize\":[\"csvConvert\"]},\"resources\":{\"queryFiles\":{\"csvq\":[],\"sql\":[],\"table\":[]}},\"context\":{\"workspace\":\"%s\",\"datasetBase\":\"%s\",\"resultBase\":\"%s\",\"settingBase\":\"%s\",\"templateBase\":\"%s\",\"jdbcBase\":\"%s\",\"xlsxSchemaBase\":\"%s\"}}"
